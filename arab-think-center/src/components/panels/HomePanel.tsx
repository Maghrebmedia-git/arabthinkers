...
const featured = {
  ...
  title: "إيران ودول الخليج المعدلة الصفرية",
  desc: "في ظل إخفاق الولايات المتحدة وإسرائيل في إسقاط النظام الحاكم في إيران تواجه دول الخليج جملة من التحديات الأمنية الوجودية يتعين عليها التعامل معها عاجلا غير أجل بشكل منفرد وجماعي.",
  index: 0,
};
